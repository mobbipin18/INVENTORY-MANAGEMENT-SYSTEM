...
class IMS:
    def __init__(self,root):
        ...
        #HEAD PART
        self.icon_title=PhotoImage(file=r"C:\Users\Acer\Documents\GitHub\INVENTORY-MANAGEMENT-SYSTEM\mainlogo.png")
        ...
        #menubar upper
        self.menulogo=Image.open(r"C:\Users\Acer\Documents\GitHub\INVENTORY-MANAGEMENT-SYSTEM\mainlogo1.png")
        ...
        stocklbl=Button (midbutton, text="ADD STOCKS", font=("Arial Bold", 20), bg="#6e0211",  fg="white",height=1)
        ...
        orderlbl=Button(midbutton, text="ORDER STOCK", font=("Arial Bold", 20), bg="#6e0211",  fg="white",height=1)
        ...
        releaselbl=Button(midbutton, text="RELEASE STOCK", font=("Arial Bold", 20), bg="#6e0211",  fg="white",height=1)
