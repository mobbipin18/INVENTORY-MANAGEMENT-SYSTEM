...
w.minsize(925,500)
w.resizable(0,0)
w.iconbitmap(r"C:\Users\Acer\Documents\GitHub\INVENTORY-MANAGEMENT-SYSTEM\My_project.ico")
...
def signin():
    ...
    b2=Button(f1,width=6,text='Sign up',border=0,bg='white',fg='#36000b',command=signup)
...
def signup():
    ...
    l2=Label(signup_win,text="Sign up",fg='#36000b',bg='white')
    l2.config(font=('Microsoft YaHei UI Light',23, 'bold'))
    l2.place(x=600,y=60)
    ...
    #-------------------------------------------------------
    Button(f1,width=39,pady=7,text='Sign up',bg='#36000b',fg='white',border=0,command=signup_cmd).place(x=35,y=204+60)
    l1=Label(f1,text="Already have an account?",fg="black",bg='white')
    l1.config(font=('Microsoft YaHei UI Light',9, ))
    l1.place(x=70,y=250+63)

    b2=Button(f1,width=6,text='Sign in',border=0,bg='white',fg='#36000b',command=signin)
