...
class billing:
    def __init__(self,root):
        ...
        self.root.geometry("900x500+300+160")  
        ...
        def add_item():
            ...
            invoice_item = [itemname, qty, price, line_total]
        ...
        qty_spinbox = tkinter.Spinbox (frame, from_=1 , to=100, font=('Arial Bold', 13), bg="white", fg="white")
        qty_spinbox.config(foreground='black')
        ...
        price_spinbox = tkinter.Spinbox(frame, from_=0.0, to=500, increment=0.5,font=('Arial Bold)', 13), bg="white", fg="black")
        ...
        columns = ('itemname', 'qty', 'price', 'total')
